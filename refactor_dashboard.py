...
REPLACEMENTS = {
    ...
    "tickets/page.tsx": [
        ...
        ('SYNC_WITH_SECURE_CHANNEL', 'SYNC_WITH_DISCORD'),
    ...
    "overview/page.tsx": [
        ('High Core neural telemetry and server activity ledger', 'Highcore Agency server activity and management logs'),
        ('Server Activity Matrix', 'Server Activity Overview'),
        ('Awaiting Telemetry Sync...', 'Connecting to System...')
    ],
    "messenger/page.tsx": [
        ('Subsystem // Comms Relay', 'Management // Messaging System'),
        ('Protocol Messenger', 'Agency Messenger'),
        ('Highcore Neural Net', 'Highcore Agency Network'),
        ('Direct Link', 'Direct Message'),
        ('Target Sync Channel', 'Target Channel'),
        ('Target Role (Optional Descriptor)', 'Target Role (Optional)'),
        ('Establishing channel lock...', 'Connecting to channel...'),
        ('PROTOCOL_WARNING: Global broadcasts are metered', 'SYSTEM_WARNING: Global broadcasts are metered'),
        ('bot fidelity', 'bot performance'),
        ('Node connection must remain active', 'Connection must remain active'),
        ('Attachment Telemetry (RAW_URL)', 'Attachment URL'),
        ('Add Peripheral Link', 'Add Another Attachment'),
        ('Data Stream Payload', 'Message Content'),
        ('TRANSMIT_GREETING_HERE...', 'ENTER_MESSAGE_HERE...'),
        ('Emoji_Sync_Enabled', 'Emoji_Support_Enabled'),
        ('Live_Telemetry', 'Live_Status'),
        ('Despatch Latency', 'Delivery Delay'),
        ('Confirm Despatch', 'Send Message'),
        ('Protocol Mode', 'Message Type'),
        ('Broadcast sequence started successfully!', 'Broadcast started successfully!')
    ],
    "commands/page.tsx": [
