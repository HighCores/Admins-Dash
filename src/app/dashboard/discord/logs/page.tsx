    ...
    <div className="w-full h-full flex flex-col min-h-0 overflow-hidden text-zinc-300 selection:bg-emerald-500/30 selection:text-emerald-400">
      ...
      <header className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-white/5 shrink-0">
        <div className="space-y-1">
          <div className="flex items-center gap-3 mb-1 font-mono">
             ...
             <span className="text-[10px] font-black text-emerald-500/60 uppercase tracking-widest leading-none">Subsystem // Neural Audit Pipeline</span>
          </div>
          ...
          <p className="text-sm font-medium text-zinc-500 max-w-xl font-mono">
             Monitoring administrative telemetry and structural modifications across the Highcore industrial manifest.
          </p>
        </div>
      ...
      {loading ? (
          <div className="flex flex-col items-center justify-center p-40 opacity-20 font-mono">
            ...
            <span className="text-[10px] uppercase font-black tracking-widest">establishing audit link...</span>
          </div>
      ) : (
             ...
             <div className="xl:col-span-8 terminal-card p-12 bg-zinc-950/40 rounded-[3rem] text-white relative overflow-hidden flex flex-col group border border-white/5">
                  ...
                  <div className="relative z-10 font-mono">
                      <div className="flex items-center gap-6 mb-12">
                          ...
                          <div>
                              <h3 className="font-black text-3xl uppercase tracking-tighter italic text-white mb-1">Administrative Node</h3>
                              <p className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.4em]">Audit Registry Configuration</p>
                          </div>
                      </div>
    
                      <div className="space-y-10 max-w-2xl">
                          <DiscordSelect 
                              label="CORE_LOG_CHANNEL"
                              type="channel"
                              value={logChannelId}
                              onChange={setLogChannelId}
                              placeholder="SELECT_SECURE_NODE..."
                          />
                  ...
                  <div className="mt-auto p-8 bg-emerald-500/5 rounded-[2.5rem] border border-emerald-500/10 flex items-center gap-8 font-mono">
                      ...
                      <div className="space-y-1">
                          <h4 className="text-[11px] font-black text-white uppercase tracking-widest italic">Live Telemetry Link Active</h4>
                          <p className="text-[10px] font-medium text-zinc-500 uppercase tracking-[0.1em] italic leading-relaxed">
                              System is actively monitoring administrative protocols, message deletions, and role metadata in real-time. Node fidelity is stable.
                          </p>
                      </div>
                  </div>
              </div>
              ...
              <div className="xl:col-span-4 terminal-card p-10 bg-zinc-900/40 rounded-[3rem] border border-white/5 flex flex-col font-mono relative overflow-hidden group">
                  ...
                  <h3 className="text-xl font-black text-white italic tracking-tighter uppercase mb-8 border-b border-white/5 pb-4">Audit Context</h3>
                  <div className="space-y-6">
                      <div className="flex flex-col gap-2 p-4 bg-black/40 rounded-xl border border-white/5 italic">
                          <span className="text-[9px] font-black text-zinc-600 uppercase">ENCRYPTION</span>
                          <span className="text-xs font-black text-emerald-500 tracking-widest uppercase italic">HC_STABLE_V4</span>
                      </div>
                      <div className="flex flex-col gap-2 p-4 bg-black/40 rounded-xl border border-white/5 italic">
                          <span className="text-[9px] font-black text-zinc-600 uppercase">AUDIT_RETENTION</span>
                          <span className="text-xs font-black text-white tracking-widest uppercase italic font-mono">FOREVER_TRACE</span>
                      </div>
                  </div>
              </div>
          </div>
