      ...
      <header className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4 shrink-0">
        <div className="space-y-1">
          ...
          <p className="text-sm font-bold text-zinc-500 max-w-2xl">
             Monitoring agency staff efficiency and response guidelines for Telegram sessions.
          </p>
        </div>
      ...
      <div className="flex-1 grid grid-cols-1 xl:grid-cols-12 gap-8 min-h-0 overflow-hidden">
                             ...
                             <div className="flex items-center gap-5 mb-8">
                                ...
                                <div className="min-w-0 pr-12">
                                    ...
                                    <div className="flex items-center gap-2 mt-2">
                                        ...
                                        <span className="text-[9px] font-black text-zinc-300 uppercase tracking-widest italic group-hover:text-blue-600 transition-colors">STAFF_ONLINE</span>
                                    </div>
                                </div>
                             </div>
        ...
        <div className="xl:col-span-4 flex flex-col gap-8 min-h-0">
             ...
             <div className="p-8 bg-zinc-950 text-white rounded-[2.5rem] shadow-2xl relative overflow-hidden group border border-zinc-900 shrink-0">
                ...
                <button className="w-full py-4 bg-white text-zinc-950 rounded-xl font-black text-[9px] uppercase tracking-[0.3em] shadow-xl hover:scale-[1.02] active:scale-95 transition-all italic underline decoration-blue-500 underline-offset-4">REWARD_TOP_STAFF</button>
            </div>
        </div>
      </div>
    </div>
