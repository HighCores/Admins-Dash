...
export default function TelegramColorsPage() {
  ...
  const handleDelete = async (name: string) => {
    ...
    await supabase.from("dc_color_roles")
        .delete()
        .eq("color_name", name)
        .eq("guild_id", "telegram_global");
    fetchRoles();
      ...
      <header className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4 shrink-0">
        <div className="space-y-1">
          ...
          <h1 className="text-3xl font-black text-zinc-950 tracking-tighter">
            Color <span className="text-blue-500">Spectrum</span>
          </h1>
          <p className="text-sm font-bold text-zinc-500 max-w-2xl">
             Calibrating identity color nodes and administrative tiers across the Telegram High Core relay.
          </p>
        </div>
          ...
          <div className="fixed inset-0 z-[1000] flex items-center justify-center p-6 backdrop-blur-2xl bg-white/10 animate-in fade-in duration-300">
             ...
             >
                ...
                <div className="space-y-6 relative z-10">
                    ...
                    <div className="space-y-2">
                        <label className="text-[9px] font-black text-zinc-400 uppercase tracking-[0.3em] px-4 font-mono leading-none italic">Identity Anchor (Group/Role ID)</label>
